...
class TestYelp(TestCase):
  ...
  ##to see if Api response matches restaurant name 
    ...
    ##Nothing is in inserted in the restaurant field (None)
    @patch('requests.get')
